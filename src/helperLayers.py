...
#class defining a basic residual block used in the generator
class ResBlock(nn.Module):
    ...
    def forward(self,inp):
        ...
        output = x + inp #skip connection
        return output

#class defining a sub pixel convolutional layer used for upscaling the input in generator
...
#class defining a convolutional block used in discriminator
